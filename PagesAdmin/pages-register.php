...
<body>
  ...
  <main style="background: linear-gradient(to top, #eee 5%, #333 80%);">
    <div class="container">
            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <div class="pt-4 pb-2">
                    <h5 class="card-title text-center pb-0 fs-4" id="textHeader">Create an Account</h5>
                  ...
                  <form class="row g-3 needs-validation" method="post" action="create.php">
                    ...
                    <div class="col-12">
                      ...
                      <div class="input-group has-validation">
                        ...
                        <div class="invalid-feedback">Please choose a CVV.</div>
                      </div>
                    </div>
                    ...
                    <div class="col-12">
                      ...
                      <input type="date" name="dateJoin" class="form-control" id="dateJoin" required>
                      <div class="invalid-feedback">Please enter your password!</div>
                    </div>
                    ...
                    <div class="col-12">
                      <button class="btn text-light w-100" type="submit" name="creatAcc" id="registerbtn">Create Account</button>
                    </div>
                    <div class="col-12">
