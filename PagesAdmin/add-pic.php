    ...
    <main id="main" class="main" class="row">
        <form method="post" enctype="multipart/form-data">
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="nameimage" name="nameimage" placeholder="ENTER NAME OF THIS IMAGE">
            </div><br>
            <div class="form-group">
    ...
    if (isset($_FILES["data"])){
        if (isset($_FILES['data']['name'])) {
            ...
            if ($_FILES['data']['size'] != 0) {
                ...
                $updateimg = $db->prepare('INSERT INTO images VALUES (DEFAULT,?,?)');
                $updateimg->execute([$_POST["nameimage"],$chemin]);
                if ($updateimg) {
