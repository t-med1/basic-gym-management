...
<body>
  ...
  <main id="main" class="main">
    ...
    <section class="section">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <table class="table">
                ...
                <tbody>
                  <?php
                  $stm = $db->prepare("SELECT * FROM member");
                  $stm->execute([]);
                  ...
                  <tr>
                    ...
                    <td>
                      <button class="btn btn-danger" type="submit">
                        <a href="delete-member.php?numM=<?= $mem->numM?>" style="color: white;">Delete</a>
                      </button>
                    </td>
                  </tr>
                  <?php
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Coach Table</h5>
              ...
              <table class="table">
                ...
                <thead>
                  <tr>
                    <th scope="col">#</th>
                    <th scope="col">Name Coach</th>
                    <th scope="col">Familly Name</th>
                    <th scope="col">Date Join</th>
                    <th scope="col">Date End</th>
                    <th scope="col">Role Coach</th>
                    <th scope="col">Action</th>
                  </tr>
                </thead>
                <tbody>
                  <?php
                  $stm = $db->prepare("SELECT * FROM coach");
                  $stm->execute([]);
                  $flag = $stm->fetchAll(PDO::FETCH_OBJ);
                  if ($flag) {
                    foreach ($flag as $mem) {
                  ...
                  <tr>
                    ...
                    <td>
                      <button class="btn btn-success" type="submit">
                        <a href="Update-coach.php?numC=<?= $mem->numCoa?>" style="color: white;">Update</a>
                      </button>
                      <button class="btn btn-danger" type="submit">
                        <a href="delete-coach.php?numC=<?= $mem->numCoa?>" style="color: white;">Delete</a>
                      </button>
                    </td>
                  </tr>
                  <?php
          ...
          <button type="submit" class="btn btn-success" name="add">
            <a href="add-coach.php" style="color: white;">ADD COACH</a>
          </button>
    </section>
