...
<body>
    ...
    if (isset($_GET["numC"])) {
        if (isset($_POST["update"])){
            $stm = $db->prepare("UPDATE coach SET nomCoa=?,prenomCoa=?,dateDebut=?,dateFin=?,roleCoa=? WHERE numCoa =?");
            $stm->execute([$_POST["nom"], $_POST["prenom"], $_POST["dateD"], $_POST["dateF"], $_POST["role"], $_GET["numC"]]);
