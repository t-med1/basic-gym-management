...
<body>
  ...
  <main id="main" class="main" class="row">
    <div class="row" style="display: flex;gap: 40px;justify-content: center; align-items: center;">
    <div class="card " style="width: 18rem;">
        <img src="./assets/img/slides-3.jpg" class="card-img-top" width="18rem">
        <div class="card-body">
          <h5 class="card-title">Number of Members</h5>
          <p class="card-text">
          <?php
            $sql="SELECT count(numM) from member";
          ...
          <a href="./tables-general.php" class="btn btn-secondary">Show Table</a>
        </div>
      </div>
      <div class="card" style="width: 18rem;">
        <img src="./assets/img/slides-1.jpg" class="card-img-top" width="18rem">
        <div class="card-body">
          <h5 class="card-title">Number of Pictures</h5>
          <p class="card-text">
          <?php
            $sql="SELECT count(idIm) from images";
            $result=$db->prepare($sql);
            $result->execute();
            $row = $result->fetch(PDO::FETCH_ASSOC);
            echo implode('',$row);
      ...
      <div class="card" style="width: 18rem;">
        <img src="./assets/img/slides-2.jpg" class="card-img-top" width="18rem">
        <div class="card-body">
          <h5 class="card-title">Number of Comments</h5>
          <p class="card-text">
          <?php
            $sql="SELECT count(numCom) from commentaire";
            $result=$db->prepare($sql);
            $result->execute();
            $row = $result->fetch(PDO::FETCH_ASSOC);
            echo implode('',$row);
