...
?>
            ...
            <div class="card-body pt-3">
              ...
              <div class="tab-content pt-2">
                ...
                <div class="tab-pane fade show active profile-overview" id="profile-overview">
                  ...
                  <p class="small fst-italic">Telaj med est un developpeur qui developpe de site du salle du sport et qui aussi l'admin de ce site .</p>

                  <h5 class="card-title">Profile Details</h5>

                  <div class="row">
                    <div class="col-lg-3 col-md-4 label ">Full Name</div>
                    <div class="col-lg-9 col-md-8"><?php if (isset($_SESSION['name']))echo $_SESSION['name'];?></div>
                  </div>

                  <div class="row">
                    <div class="col-lg-3 col-md-4 label">Company</div>
                    <div class="col-lg-9 col-md-8">De Developpement Full Stack</div>
                  </div>

                  <div class="row">
                    <div class="col-lg-3 col-md-4 label">Job</div>
                    <div class="col-lg-9 col-md-8">dev Front-End/Back-End</div>
                  </div>

                  <div class="row">
                    <div class="col-lg-3 col-md-4 label">City </div>
                    <div class="col-lg-9 col-md-8"><?php if (isset($_SESSION['ville']))echo $_SESSION['ville'];?></div>
                  </div>

                  <div class="row">
                    <div class="col-lg-3 col-md-4 label">Phone</div>
                    <div class="col-lg-9 col-md-8">+212 <?php if (isset($_SESSION['phone']))echo $_SESSION['phone'];?></div>
                  </div>

                  <div class="row">
                    <div class="col-lg-3 col-md-4 label">Email</div>
                    <div class="col-lg-9 col-md-8"><?php if (isset($_SESSION['mailAd']))echo $_SESSION['mailAd'];?></div>
                  </div>
                  ...
                  <form method="post">
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <input name="password" type="password" class="form-control" id="currentPassword" value="<?php if (isset($_SESSION['passwordAd']))echo $_SESSION['passwordAd'];?>">
                      </div>
                    </div>
  ...
  <?php
    if (isset($_POST["change"])){
      $id = $_SESSION['codeAd'];
      $stm = $db->prepare("UPDATE admins SET passAd=:pass where numAd=:num");
      $stm->execute([":pass" => $_POST["newpassword"], ":num" => $id]);
      $updt = $stm->fetch(PDO::FETCH_OBJ);
    }
  ?>
  <!-- Vendor JS Files -->
